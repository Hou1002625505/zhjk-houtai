		...
		<div class="xzhd-body-flex" style="margin-top:24px;position: relative;">
			...
			<div class="lqPeople">
				...
				<div class="xzhd-body-input">
					...
					<div class="leftborder">
						<div class="topArrow"><img src="../images/upfoldicomtwo.png"></div>
						<div class="bottomArrow"><img src="../images/upfoldicomtwo.png"></div>
					</div>
				</div>
			</div>
					...
					if (data.length > 0) {
						...
						for (var i = 0; i < data.length; i++) {
							...
							var str = '<tr>' +
								...
								'<td class="item fitem5f ">' + (item.state == 0 ? '未开始' : item.state == 1 ? '活动中' : item.state == 2 ? '已结束' : '') + '</td>' +
								'<td class="item fitem2f ">' +
			...
			success: function (res) {
				...
				if (res.status) {
					...
					if (intoNum != 0) {
						...
						pagination.init(obj);
						$("#wswq2 .page").html("共" + res.total + "条，每页" + eachPage + "条")
