				...
				<div title="配置中心" style="padding: 10px;">
					<div align="left">
						...
						<shiro:hasPermission name="100506">
							<a href="#" onclick="javascript:addTab('系统参数','rest/sysparam/sysparammanage');"class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-pzzxxtcs',width:'150px',iconAlign:'left'">系统参数</a>
						</shiro:hasPermission> 
