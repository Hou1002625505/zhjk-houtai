...
<body class="easyui-layout">
	<div class="msk">
		<div class="leave_sure" id="leave_sure1"
			style="top: 50%;margin-top: -246px;">
	...
	<div data-options="region:'north',border:false"
		style="height: 70px; padding: 5px;font-size: 15px;background-color: #fff;"
		align="right">
		<div class="zh_login"></div>
		<div class="zh_name">中航健身会CRM后台管理系统</div>
		<div class="information">
			<font color="#444444" style="margin-right: 10px;">【当前会所】<span
				id="clubName" style="margin-left: 15px;"></span>
			</font><font color="#444444">【<%=request.getAttribute("realName")%>】<input
				type="hidden" value="<%=request.getAttribute("realName")%>"
				id="username" /> 【欢迎登录】
			</font><a href="#" onclick="updatePassword()"><font color="#444444"
				style="margin: 0 5px;">【修改密码】</font></a><a href="rest/user/logout"><font
				color="#444444">【退出】</font></a>
		</div>
	</div>
	<div data-options="region:'south',split:true" style="height: 30px;"
		align="center">Copyright 2017</div>
	<div data-options="region:'west',split:true,iconCls:'icon-folder_up'"
		title="主菜单" style="width: 180px;">
				...
				<div title="前台管理" style="padding: 10px;">
					<div align="left">
						<shiro:hasPermission name="100706">
							<a href="#"
								onclick="javascript:addTab('入离场','rest/customer/packagemenu/fitnessMenu');"
								class="easyui-linkbutton"
								data-options="plain:true,iconCls:'icon-pj',width:'150px',iconAlign:'left'">入离场</a>
						</shiro:hasPermission>
						<shiro:hasPermission name="100703">
							<a href="#"
								onclick="javascript:addTab('私教日程表','rest/order/orderListPage');"
								class="easyui-linkbutton"
				...
				<div title="客户管理" style="padding: 10px;">
					<div align="left">
						<shiro:hasPermission name="100104">
							<a href="#"
								onclick="javascript:addTab('客户详情','rest/customer/card/customerCardList');"
								class="easyui-linkbutton"
						...
						<shiro:hasPermission name="100109">
							<a href="#"
								onclick="javascript:addTab('电子合同','rest/customerGx/customerStatementListPc');"
								class="easyui-linkbutton"
				...
				<div title="私教管理" style="padding: 10px;">
					<div align="left">
						<shiro:hasPermission name="100601">
							<a href="#"
								onclick="javascript:addTab('私教员工管理','rest/user/privatemanagement');"
								class="easyui-linkbutton" 
						...
						<shiro:hasPermission name="100604">
							<a href="#"
								onclick="javascript:addTab('课时发布浏览','rest/order/courseBrowsePage');"
								class="easyui-linkbutton"
								data-options="plain:true,iconCls:'icon-tc4',width:'150px',iconAlign:'left'">课时发布浏览</a>
						</shiro:hasPermission>
						<shiro:hasPermission name="100605">
							<a href="#"
								onclick="javascript:addTab('私教照片审核','rest/user/privatePicture');"
								class="easyui-linkbutton"
				...
				<div title="团课管理" style="padding: 10px;">
					<div align="left">
						...
						<shiro:hasPermission name="100806">
							<a href="#"
							   onclick="javascript:addTab('课程表','rest/classScheduling/classSchedulingList');"
							   class="easyui-linkbutton"
				...
				<div title="营销管理" style="padding: 10px;">
					<div align="left">
						...
						<shiro:hasPermission name="100207">
							<a href="#"
								onclick="javascript:addTab('体验券管理','rest/coupon/couponListPage');"
								class="easyui-linkbutton"
			...
			<shiro:hasPermission name="1009">
				<div title="B2B管理" style="padding: 10px;">
					...
					<shiro:hasPermission name="100902">
							<a href="#"
								onclick="javascript:addTab('企业档案','rest/business/archives/archivesPage');"
								class="easyui-linkbutton"
								data-options="plain:true,iconCls:'icon-B2Bqyda',width:'150px',iconAlign:'left'">企业档案</a>
						</shiro:hasPermission>
						<shiro:hasPermission name="100901">
							<a href="#"
								onclick="javascript:addTab('申请列表','rest/business/apply/applyPage');"
								class="easyui-linkbutton"
			...
			<shiro:hasPermission name="1005">
				<div title="配置中心" style="padding: 10px;">
					...
					<shiro:hasPermission name="100504">
							<a href="#"
								onclick="javascript:addTab('标签库','rest/tagKu/tagGroup/customerLabelPage');"
								class="easyui-linkbutton"
								data-options="plain:true,iconCls:'icon-biaoqianku',width:'150px',iconAlign:'left'">标签库</a>
						</shiro:hasPermission>
						...
						<shiro:hasPermission name="100501">
							<a href="#"
								onclick="javascript:addTab('门店配置管理','rest/club/clublistpage');"
								class="easyui-linkbutton"
								data-options="plain:true,iconCls:'icon-upSale2',width:'150px',iconAlign:'left'">门店配置管理</a>
							<a href="#"
								onclick="javascript:addTab('组织机构管理','rest/department/deptpage');"
								class="easyui-linkbutton"
								data-options="plain:true,iconCls:'icon-zzjg',width:'150px',iconAlign:'left'">组织机构管理</a>
						</shiro:hasPermission>
						<shiro:hasPermission name="100505">
							<a href="#" onclick="javascript:addTab('动作库导入','rest/coach/plan/actionList');"class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-undo',width:'150px',iconAlign:'left'">动作库导入</a>
						</shiro:hasPermission> 
						<shiro:hasPermission name="100506">
							<a href="#" onclick="javascript:addTab('系统参数','rest/sysparam/sysparammanage');"class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-pzzxxtcs1',width:'150px',iconAlign:'left'">系统参数</a>
						</shiro:hasPermission> 
						<shiro:hasPermission name="100510">
							<a href="#" onclick="javascript:addTab('动作维护','rest/coach/plan/actionHouseList');"class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-undo1',width:'150px',iconAlign:'left'">动作维护</a>
						</shiro:hasPermission> 
						<shiro:hasPermission name="100509">
							<a href="#"
								onclick="javascript:addTab('方案模板','rest/coach/plan/planUploadList');"
								class="easyui-linkbutton"
				...
				<div title="权限管理" style="padding: 10px;">
					<div align="left">
						...
						<shiro:hasPermission name="100405">
							<a href="#"
								onclick="javascript:addTab('后台日志','rest/syslog/getLogListpage');"
								class="easyui-linkbutton"
	...
	<div data-options="region:'center',iconCls:'icon-home'">
		<div class="easyui-tabs"
			data-options="fit:true,border:false,plain:true" id="ss">
			<div title="系统介绍" data-options="href:'content.html'"
				style="padding: 10px"></div>

		</div>
	</div>
	<div id="w" class="easyui-dialog" title="用户信息"
				...
				<table align="center">
					<tr>
						...
						<td><input class="easyui-textbox" type="password"
							name="password" invalidMessage="最大长度不能超过20!"
					...
					<tr>
						<td>新密码:</td>
						<td><input class="easyui-textbox" type="password"
							name="password1" invalidMessage="最大长度不能超过20!"
	...
	<form action="rest/user/loginAgain" id="login_form" method="post"
		style="display: none;">
		<div class="form-group">
			<label for="j_username" class="t">用户名：</label><input id="userName"
				value="" name="userName" type="text" class="form-control x319 in"
				autocomplete="off">
		</div>
		<br>
		<div class="form-group">
			<label for="j_password" class="t">密 码：</label> <input id="passWord"
	...
	<script src="../easyui/jquery.event.ue.js" type="text/javascript"
		charset="utf-8"></script>
	<script src="../easyui/jquery.udraggable.js" type="text/javascript"
		charset="utf-8"></script>
	<script type="text/javascript">
		//查询会所
