...
<script type="text/javascript">
    ...
    class computed {
        ...
        pay() {
            //新增窗口单选框的显示及排他
            this.paypay.children('.paypay-show').hide()
            this.paypay.children('.paypay-hidden').show()
            ...
            this.paypaypay.children('.paypaypay-show').hide()
            this.paypaypay.children('.paypaypay-hidden').show()
